...
{
    extract($data);//extract က associative array ကို variable အနေနဲ့ပြောင်းလဲပေး ဉပမာ associative array ထဲမှာ users ဆိုရင် $usersဆိုတဲ့ variable အဖြစ်‌ပြောင်းလဲသွားပြီး view မှာလဲ$usersနဲ့ပဲအလုပ်လုပ်
